        ...
        <div>
            ...
            >
                ...
                <div className="form__container">
                    ...
                    <input type="text" className="form__input" name="email" title="Por favor escriba su correo electrónico" required/>

                    <label className="form__label">Número telefónico</label>
                    <input type="number" className="form__input" name="phoneNumber" title="Por favor escriba su número telefónico" required/>

                    <label className="form__label">Asunto</label>
                    <input type="text" className="form__input" name="requestSubject" title="Por favor escriba su asunto" required/>

                    <label className="form__label">Mensaje</label>
                    <textarea className="form__input form__input--message" name="message" title="Por favor escriba su mensaje" required></textarea>
